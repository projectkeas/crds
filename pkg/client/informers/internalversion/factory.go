...
import (
	...
	v1alpha1 "github.com/projectkeas/crds/pkg/client/informers/internalversion/v1alpha1"
...
type SharedInformerFactory interface {
	...
	Keas() v1alpha1.Interface
}

func (f *sharedInformerFactory) Keas() v1alpha1.Interface {
