...
type EventTypeInterface interface {
	Create(ctx context.Context, eventType *v1alpha1.EventType, opts v1.CreateOptions) (*v1alpha1.EventType, error)
	Update(ctx context.Context, eventType *v1alpha1.EventType, opts v1.UpdateOptions) (*v1alpha1.EventType, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.EventType, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.EventTypeList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EventType, err error)
	EventTypeExpansion
}
...
func newEventTypes(c *KeasV1alpha1Client, namespace string) *eventTypes {
	return &eventTypes{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *eventTypes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EventType, err error) {
...
func (c *eventTypes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EventTypeList, err error) {
...
func (c *eventTypes) Create(ctx context.Context, eventType *v1alpha1.EventType, opts v1.CreateOptions) (result *v1alpha1.EventType, err error) {
	result = &v1alpha1.EventType{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("eventtypes").
...
func (c *eventTypes) Update(ctx context.Context, eventType *v1alpha1.EventType, opts v1.UpdateOptions) (result *v1alpha1.EventType, err error) {
	result = &v1alpha1.EventType{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("eventtypes").
...
func (c *eventTypes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EventType, err error) {
	result = &v1alpha1.EventType{}
